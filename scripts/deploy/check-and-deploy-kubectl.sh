...
if [ -z "${DEPLOYMENT_FILE}" ]; then DEPLOYMENT_FILE=deployment.template.yml ; fi
echo "Initalizing deployment file from template ${DEPLOYMENT_FILE}."
deployment_content=$(cat ${DEPLOYMENT_FILE})
# Find the port
